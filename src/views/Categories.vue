<template>
    <div class="flex flex-col lg:w-10/12 mx-auto bg-gray-200 lg:bg-gray-100">
        <div class="bg-blue-700">
            <img :src="require('../assets/informatiqueBanner.jpg')" alt="" />
        </div>
        <div class="flex">
            <div class="hidden lg:flex lg:h-screen lg:bg-green-500 lg:w-1/3">
                test
            </div>
            <div class="flex flex-col w-full space-y-2">
                <div
                    class="h-36 lg:h-48 rounded-md flex lg:transition lg:duration-500 lg:ease-in-out lg:transform lg:hover:scale-105 lg:hover:shadow-md bg-white"
...
export default {
    setup() {
        ...
        return { categorie, products, currency }
    },
}
</script>
